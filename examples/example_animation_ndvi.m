...
modisncfile = '/Users/jmissik/Desktop/repos.nosync/pymovebank/pymovebank/datasets/user_datasets/MODIS_NDVI_resampled2.nc';
% file3 = '/Users/jmissik/Desktop/repos.nosync/pymovebank/pymovebank/datasets/user_datasets/MODIS_NDVI_resampled2.nc';

output_directory = '/Users/jmissik/Desktop/repos.nosync/movebank_vis/output';
output_fname = 'test_animation_resampled.avi';

start_time = datetime('2002-06-26 00:00:00');
% end_time = datetime('2004-09-30 00:00:00');
end_time = datetime('2002-08-26 00:00:00');
